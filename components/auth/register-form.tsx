  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
      ...
      <div className="relative container w-screen">
        <div className="flex items-center justify-center max-w-7xl mx-auto px-4 min-h-screen">
          {/* Main Container */}
          <div className="w-full max-w-6xl">
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border rounded-3xl shadow-2xl overflow-hidden">
              <div className="grid lg:grid-cols-2 min-h-[600px]">
                ...
                <div className="p-8 lg:p-12 bg-gradient-to-br from-purple-600/10 to-blue-600/10 flex flex-col justify-center">
                  <div className="w-full max-w-md mx-auto text-center">
                    <div className="flex items-center text-ceter justify-center gap-4 mb-16">
                    ...
                    <div className="space-y-6">
                      ...
                      <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
                        انضم إلى آلاف المستخدمين في رحلة التعلم الذكي واكتشف قوة
                        الذكاء الاصطناعي في تحليل المستندات
                      </p>
