...
export function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to the library page and refresh
        ...
        <div className="grid gap-6">
          <form onSubmit={handleSubmit}>
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                <Label htmlFor="confirmPassword" className={cn(errors.confirmPassword && "text-destructive")}>
                  Confirm Password
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" type="button" disabled={isLoading} className="flex items-center justify-center">
              <svg
