  ...
  const termsSection = [
    {
      ...
      title: "قبول الشروط",
      icon: CheckCircle,
      content: `باستخدام منصة ${APP_NAME} ("الخدمة")، فإنك تقبل وتوافق على الالتزام بشروط وأحكام هذه الاتفاقية. إذا كنت لا توافق على الالتزام بما سبق، يرجى عدم استخدام هذه الخدمة.
...
تشكل هذه الشروط اتفاقية ملزمة قانونياً بينك وبين ${APP_NAME}. يرجى قراءتها بعناية لأنها تؤثر على حقوقك والتزاماتك القانونية.`,
    },
    {
      id: "definitions",
      title: "التعريفات",
...
• "الخدمة" تشير إلى منصة ${APP_NAME}، بما في ذلك الموقع الإلكتروني والتطبيقات المحمولة والخدمات ذات الصلة
...
• "معالجة الذكاء الاصطناعي" تعني تحليل الذكاء الاصطناعي وملخص المستندات التي ترفعها`,
    },
    {
      ...
      icon: Scale,
      content: `توافق على استخدام ${APP_NAME} للأغراض القانونية فقط ووفقاً لهذه الشروط. توافق على عدم استخدام الخدمة:
...
• قد تؤدي الانتهاكات المتكررة إلى تعليق أو إنهاء الحساب`,
    },
    {
      ...
      icon: FileText,
      content: `محتواك:
تحتفظ بجميع الحقوق للمحتوى الذي ترفعه إلى ${APP_NAME}. باستخدام خدمتنا، تمنحنا ترخيصاً محدوداً لمعالجة محتواك حصرياً لغرض تقديم خدمات تحليل وملخص الذكاء الاصطناعي لدينا.

محتوانا:
الخدمة، بما في ذلك تصميمها وميزاتها وتقنيتها وخوارزميات الذكاء الاصطناعي، مملوكة ل${APP_NAME} ومحمية بموجب قوانين حقوق النشر والعلامات التجارية والملكية الفكرية الأخرى.
...
${APP_NAME}، وشعاراتنا، وعلامات الخدمة هي علامات تجارية ل${APP_NAME} إنك. لا يجوز لك استخدام علاماتنا التجارية دون موافقتنا الكتابية المسبقة.`,
    },
    {
      id: "privacy",
        ...
        <div className="relative container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              تحكم هذه الشروط استخدامك لمنصة ${APP_NAME}. باستخدام منصة القراءة
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                إليك أهم النقاط التي يجب أن تعرفها حول استخدام ${APP_NAME}.
              </p>
            </div>
            ...
            <Alert className="border-orange-200 dark:border-orange-800 bg-orange-50 dark:bg-orange-900/20">
              ...
              <AlertDescription className="text-orange-800 dark:text-orange-200 text-right">
                <strong>مهم:</strong> بإنشاء حساب أو استخدام ${APP_NAME}، فإنك
                توافق على الالتزام بشروط الخدمة هذه. إذا كنت لا توافق على أي جزء
                من هذه الشروط، يرجى عدم استخدام خدمتنا.
              </AlertDescription>
            </Alert>
          </div>
        </div>
