...
export function BookDetails({ bookInfo, onUpdateBookInfo, isNew = false }: BookDetailsProps) {
  ...
  const [isOwnedByUser, setIsOwnedByUser] = useState(bookInfo.isOwnedByUser || false)
  const [coverImageUrl, setCoverImageUrl] = useState<string | undefined>(bookInfo.coverImageUrl)
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-5">
            <div className="space-y-2">
              ...
              <Input id="book-title" value={title} onChange={handleTitleChange} placeholder="Enter book title" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="book-author" value={author} onChange={handleAuthorChange} placeholder="Enter author name" />
            </div>
            ...
            <div className="flex items-center space-x-2 pt-3">
              <Checkbox id="ownership" checked={isOwnedByUser} onCheckedChange={handleOwnershipChange} />
              <Label htmlFor="ownership" className="text-sm font-medium cursor-pointer">
                I confirm that I own the rights to this book or have permission to use it
              </Label>
            </div>
            ...
            {!isOwnedByUser && hasChanges && (
              <Alert variant="destructive" className="mt-3">
                ...
                <AlertDescription>
                  You must confirm that you own the rights to this book or have permission to use it before saving.
                </AlertDescription>
              </Alert>
            )}

            <div className="flex flex-col sm:flex-row gap-3 mt-6">
              <Button onClick={handleSave} disabled={!hasChanges || !isOwnedByUser || !title || !author}>
          ...
          <div className="space-y-3">
            ...
            <div
              className={cn(
                ...
                isDragging ? "border-primary bg-primary/5" : "border-dashed border-primary/50 hover:border-primary",
              )}
              ...
              {coverImageUrl ? (
                ...
                <div className="aspect-[2/3] w-full flex flex-col items-center justify-center p-6 text-muted-foreground cursor-pointer">
                  ...
                  <p className="text-center text-sm">
                    {isDragging ? "Drop image here" : "Click or drag to upload cover image"}
                  </p>
                </div>
              )}
            </div>
